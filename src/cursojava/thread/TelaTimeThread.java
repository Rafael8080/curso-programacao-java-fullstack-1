...
public class TelaTimeThread extends JDialog	{
	...
	public TelaTimeThread() { /*Executa o que tiver dentro no momento da abertura ou execução*/	
		...
		//Centralizando um elemento com base em um outro componente, mas como não temos por padrão ele centraliza
		//Proibe o usuario aumentar a largura e altura e fica a tela fica com tamanho padrão
